...
struct SourceAppsView: View {
    @AppStorage("VexSign.sortOptionRawValue") private var _sortOptionRawValue: String = SortOption.date.rawValue
    @AppStorage("VexSign.sortAscending") private var _sortAscending: Bool = true
