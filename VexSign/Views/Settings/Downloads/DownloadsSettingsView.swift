...
struct DownloadsSettingsView: View {
	@AppStorage("VexSign.downloadDisplayMode")
	private var _downloadDisplayMode: String = "floating"

	@AppStorage("VexSign.backgroundDownloadHeaderStartState")
	private var _backgroundDownloadHeaderStartState: String = "collapsed"

	@AppStorage("VexSign.showDownloadHeaderInSourcesTab")
	private var _showDownloadHeaderInSourcesTab: Bool = true

	@AppStorage("VexSign.downloadOverlayTheme")
	private var _downloadOverlayTheme: String = "default"

	@AppStorage("VexSign.dynamicOverlaySize")
